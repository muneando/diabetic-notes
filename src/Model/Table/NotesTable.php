 ...
 * @property \App\Model\Table\MyCategoriesTable|\Cake\ORM\Association\BelongsTo $MyCategories
 *
...
class NotesTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->belongsTo('MyCategories', [
            'foreignKey' => 'my_categories_id',
            'joinType' => 'INNER'
        ]);
    }
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        $rules->add($rules->existsIn(['my_categories_id'], 'MyCategories'));
